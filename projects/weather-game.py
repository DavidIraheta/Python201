...
def get_weather(location):
    api_key = "1a7ec3eb8d2b4116b24180946242012"  
    ...
    try:
        ...
        print(f"Weather in {location}: {weather_state}, {temp_c}°C / {temp_f}°F")
...
current_weather = get_weather("Denver")
print(f"The current weather is {current_weather}.")

# apply weather effects
current_weather = get_weather("Denver")  

if current_weather in ["Rain", "Thunderstorm"]:
    player["defense"] += 2
    print("It's rainy. Your defense has increased by 2!")
elif current_weather in ["Sunny", "Clear"]:
    player["attack"] += 4
    print("The sun boosts your spirits! Your attack has increased by 2!")
elif current_weather == "Snow":
    player["health"] += 3
    print("The snowy weather invigorates you. Your health has increased by 5!")
else:
    print(f"The weather is {current_weather}, but it has no effect.")
